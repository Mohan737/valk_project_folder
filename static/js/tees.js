    ...
    const cost = 1100;
    const cost_both = 1399;
    // document.getElementById('amnt').innerHTML = cost


    
    // document.getElementById('amnt').innerHTML = cost_both

    // const cost_diff = 299;
    // document.getElementById('amnt1').innerHTML = cost_diff
    // document.getElementById("cost").classList.add("hide");
    // document.getElementById("cost2").classList.remove("hide");
    ...
    function save() {
        ...
        html2canvas(u, {
            ...
            a.click();
            document.body.removeChild(a);
            //add async await to checkout page hereeeeee!!!!!!
            //window.open('t_c.html');
            // putdeets(dis_p);
